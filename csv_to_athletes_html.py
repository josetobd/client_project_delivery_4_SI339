...
def gen_athlete_page(data, outfile):
   ...
   <header>
      <!--Athlete would input headshot-->
       <h1>{data["name"]}</h1>
      <a href = "../images/profiles/{data["athlete_id"]}.jpg"  data-lightbox="tea" target="_blank">
   ...
   html_content += '''                   
                        ...
                        <section id="athlete-result-table">
                           <label for="table-filter">Search Race Results:</label>
                           <input type="text" id="table-filter" onkeyup="filterTable()" placeholder="Type to search...">
                           <div>
                              <button onclick="sortTable('athlete-table', 0)">Sort by Race</button>
                              <button onclick="sortTable('athlete-table', 1)">Sort by Athlete Time</button>
                              <button onclick="sortTable('athlete-table', 2)">Sort by Athlete Place</button>
                              <button onclick="sortTable('athlete-table', 3)">Sort by Race Comments</button>
                           </div>
   ...
   html_content += '''
                    ...
                    Follow us on Instagram <a href = "https://www.instagram.com/a2skylinexc/" aria-label="Instagram"><i class="fa-brands fa-instagram" aria-label="Instagram"></i>  </a> 
